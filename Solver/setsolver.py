...
def Launch_Solver(sets,constraints, une_solution=False): # FlatBat 
	...
	for c in constraints:
		if c[0]=="":
			...
			cstrobjs.append(Union(get_num_var(setobjs,c[1]),get_num_var(setobjs,c[2]),get_num_var(setobjs,c[3]),0))
		elif c[0]=="intersect":
			cstrobjs.append(Intersection(get_num_var(setobjs,c[1]),get_num_var(setobjs,c[2]),get_num_var(setobjs,c[3]),1))
		elif c[0]=="cardeq":
