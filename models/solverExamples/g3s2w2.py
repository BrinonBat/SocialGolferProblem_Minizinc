	...
	["G13",set({1,2,3,4}),False],
	["G21",set({1,2,3,4}),False],
	["G22",set({1,2,3,4}),False],
	["G23",set({1,2,3,4}),False],


	["G11nG12",set({1,2,3,4}),False],
	["G11nG13",set({1,2,3,4}),False],
	["G11nG21",set({1,2,3,4}),False],
	["G11nG22",set({1,2,3,4}),False],
	["G11nG23",set({1,2,3,4}),False],

	["G12nG13",set({1,2,3,4}),False],
	["G12nG21",set({1,2,3,4}),False],
	["G12nG22",set({1,2,3,4}),False],
	["G12nG23",set({1,2,3,4}),False],

	["G13nG21",set({1,2,3,4}),False],
	["G13nG22",set({1,2,3,4}),False],
	["G13nG23",set({1,2,3,4}),False],

	["G21nG22",set({1,2,3,4}),False],
	["G21nG23",set({1,2,3,4}),False],

	["G22nG23",set({1,2,3,4}),False],
	]
